...
test_aprint_instruction:: proc(test_runner: ^testing.T) {
	...
	log.info(aprint_ADC(GBA_ADC_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_ADD(GBA_ADD_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_AND(GBA_AND_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_B(GBA_B_Instruction_Decoded{ cond = .PLUS, target_address = 86 }))
	log.info(aprint_BL(GBA_BL_Instruction_Decoded{ cond = .PLUS, target_address = 86 }))
	log.info(aprint_BIC(GBA_BIC_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_BX(GBA_BX_Instruction_Decoded{ cond = .PLUS, target_address = 86, thumb_mode = true }))
	log.info(aprint_CMN(GBA_CMN_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53 }))
	log.info(aprint_CMP(GBA_CMP_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53 }))
	log.info(aprint_EOR(GBA_EOR_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_LDM(GBA_LDM_Instruction_Decoded{ cond = .PLUS, destination_registers = { .R4, .R11, .CPSR }, start_address = 47 }))
	log.info(aprint_LDR(GBA_LDR_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_LDRB(GBA_LDRB_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_LDRBT(GBA_LDRBT_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_LDRH(GBA_LDRH_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_LDRSB(GBA_LDRSB_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_LDRSH(GBA_LDRSH_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_LDRT(GBA_LDRT_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_MLA(GBA_MLA_Instruction_Decoded{ cond = .PLUS, operand = 14, multiplicand = 53, addend = 23, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_MOV(GBA_MOV_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, shifter_operand = 32 }))
	log.info(aprint_MRS(GBA_MRS_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, source = gba_core.logical_registers.cpsr }))
	log.info(aprint_MSR(GBA_MSR_Instruction_Decoded{ cond = .PLUS, destination = .CPSR, operand = 32 }))
	log.info(aprint_MUL(GBA_MUL_Instruction_Decoded{ cond = .PLUS, operand = 14, multiplicand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_MVN(GBA_MVN_Instruction_Decoded{ cond = .PLUS, destination = gba_core.logical_registers.r4, shifter_operand = 32 }))
	log.info(aprint_ORR(GBA_ORR_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_RSB(GBA_RSB_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_RSC(GBA_RSC_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_SMLAL(GBA_SMLAL_Instruction_Decoded{ cond = .PLUS, operand = 14, multiplicands = { 53, 19 }, destinations = { gba_core.logical_registers.r4, gba_core.logical_registers.r5 } }))
	log.info(aprint_SMULL(GBA_SMULL_Instruction_Decoded{ cond = .PLUS, operand = 14, multiplicands = { 53, 19 }, destinations = { gba_core.logical_registers.r4, gba_core.logical_registers.r5 } }))
	log.info(aprint_STM(GBA_STM_Instruction_Decoded{ cond = .PLUS, source_registers = { .R4, .R11, .CPSR }, start_address = 47 }))
	log.info(aprint_STR(GBA_STR_Instruction_Decoded{ cond = .PLUS, source = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_STRB(GBA_STRB_Instruction_Decoded{ cond = .PLUS, source = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_STRBT(GBA_STRBT_Instruction_Decoded{ cond = .PLUS, source = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_STRH(GBA_STRH_Instruction_Decoded{ cond = .PLUS, source = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_STRT(GBA_STRT_Instruction_Decoded{ cond = .PLUS, source = gba_core.logical_registers.r4, address = 47 }))
	log.info(aprint_SUB(GBA_SUB_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53, destination = gba_core.logical_registers.r4 }))
	log.info(aprint_SWI(GBA_SWI_Instruction_Decoded{ cond = .PLUS, immediate = 14 }))
	log.info(aprint_SWP(GBA_SWP_Instruction_Decoded{ cond = .PLUS, source_register = gba_core.logical_registers.r4, destination_register = gba_core.logical_registers.r5 }))
	log.info(aprint_SWPB(GBA_SWPB_Instruction_Decoded{ cond = .PLUS, source_register = gba_core.logical_registers.r4, destination_register = gba_core.logical_registers.r5 }))
	log.info(aprint_TEQ(GBA_TEQ_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53 }))
	log.info(aprint_TST(GBA_TST_Instruction_Decoded{ cond = .PLUS, operand = 14, shifter_operand = 53 }))
	log.info(aprint_UMLAL(GBA_UMLAL_Instruction_Decoded{ cond = .PLUS, operand = 14, multiplicands = { 53, 19 }, destinations = { gba_core.logical_registers.r4, gba_core.logical_registers.r5 } }))
	log.info(aprint_UMULL(GBA_UMULL_Instruction_Decoded{ cond = .PLUS, operand = 14, multiplicands = { 53, 19 }, destinations = { gba_core.logical_registers.r4, gba_core.logical_registers.r5 } }))
	log.info(aprint_UNDEF(GBA_Undefined_Instruction_Decoded{ })) }