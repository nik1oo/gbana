...
Color:: bit_field u16 {
	...
	blue:  u8 | 5 }
GPU:: struct {
	using registers: GPU_Registers }
gpu: ^GPU
GPU_Registers:: struct {
...
init_gpu:: proc() {
	...
	gpu.vcount=   (^i16)              (&slice.reinterpret([]u8, memory.data)[REG_VCOUNT_ADDR])
	gpu.bg0cnt=   (^BGCNT_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG0CNT_ADDR])
	gpu.bg1cnt=   (^BGCNT_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG1CNT_ADDR])
	gpu.bg2cnt=   (^BGCNT_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2CNT_ADDR])
	gpu.bg3cnt=   (^BGCNT_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3CNT_ADDR])
	gpu.bg0hofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG0HOFS_ADDR])
	gpu.bg0vofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG0VOFS_ADDR])
	gpu.bg1hofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG1HOFS_ADDR])
	gpu.bg1vofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG1VOFS_ADDR])
	gpu.bg2hofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2HOFS_ADDR])
	gpu.bg2vofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2VOFS_ADDR])
	gpu.bg3hofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3HOFS_ADDR])
	gpu.bg3vofs=  (^BGOFS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3VOFS_ADDR])
	gpu.bg2pa=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2PA_ADDR])
	gpu.bg3pa=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3PA_ADDR])
	gpu.bg2pb=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2PB_ADDR])
	gpu.bg3pb=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3PB_ADDR])
	gpu.bg2pc=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2PC_ADDR])
	gpu.bg3pc=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3PC_ADDR])
	gpu.bg2pd=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG2PD_ADDR])
	gpu.bg3pd=    (^BGORS_Register)   (&slice.reinterpret([]u8, memory.data)[REG_BG3PD_ADDR])
	gpu.bg2x=     (^BGXY_Register)    (&slice.reinterpret([]u8, memory.data)[REG_BG2X_ADDR])
	gpu.bg3x=     (^BGXY_Register)    (&slice.reinterpret([]u8, memory.data)[REG_BG3X_ADDR])
	gpu.bg2y=     (^BGXY_Register)    (&slice.reinterpret([]u8, memory.data)[REG_BG2Y_ADDR])
	gpu.bg3y=     (^BGXY_Register)    (&slice.reinterpret([]u8, memory.data)[REG_BG3Y_ADDR])
	gpu.win0h=    (^WINH_Register)    (&slice.reinterpret([]u8, memory.data)[REG_WIN0H_ADDR])
	gpu.win1h=    (^WINH_Register)    (&slice.reinterpret([]u8, memory.data)[REG_WIN1H_ADDR])
	gpu.win0v=    (^WINV_Register)    (&slice.reinterpret([]u8, memory.data)[REG_WIN0V_ADDR])
	gpu.win1v=    (^WINV_Register)    (&slice.reinterpret([]u8, memory.data)[REG_WIN1V_ADDR])
	gpu.winin=    (^WININ_Register)   (&slice.reinterpret([]u8, memory.data)[REG_WININ_ADDR])
	gpu.winout=   (^WINOUT_Register)  (&slice.reinterpret([]u8, memory.data)[REG_WINOUT_ADDR])
	gpu.mosaic=   (^MOSAIC_Register)  (&slice.reinterpret([]u8, memory.data)[REG_MOSAIC_ADDR])
	gpu.bldcnt=   (^BLDCNT_Register)  (&slice.reinterpret([]u8, memory.data)[REG_BLDCNT_ADDR])
}
